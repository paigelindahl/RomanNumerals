...
<div class="grid grid-cols-12 w-full gap-5">
    <div class="col-span-12 md:col-span-4 border border-gray-200 bg-white shadow-md rounded-lg p-5">
        <slot name="input-container"></slot>
    </div>
    <div class="col-span-12 md:col-span-8 border border-gray-200 shadow-md rounded-lg">
        <div class="grid grid-cols-12 rounded-lg gap-y-0.5 h-full">
            <div class="col-span-12 bg-blue-200 rounded-t-lg p-4 flex items-center">
